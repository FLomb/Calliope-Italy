...
from nos_utils import cap_share_calc, update_nos_score, vres_diff_per_loc
import numpy as np
import pandas as pd
...
update_nos_score(cap_share_per_loc_1)
...
for j in range(2,(n+1)):
    ...
    update_nos_score(cap_share_dict[j])
...
'''
for j in range(2,(n+1)):
    print(vres_diff_per_loc(nos_dict[j],model_plan_1))
