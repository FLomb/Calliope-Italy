...
#model_test = calliope.Model('model_20.yaml')
#model_test.run()

model_test2 = calliope.Model('model_20.yaml', scenario='no_heat')
model_test2.run()
...
el_prod_base_op = model_test2.get_formatted_array('carrier_prod').loc[{'carriers':'electricity'}].sum(['locs','timesteps']).to_pandas().T #electricity production per technology in kWh

#%% Multi-node Graph pre-processing

#tot_NORD = model_test.get_formatted_array('carrier_prod').loc[{'carriers':'electricity','locs':['NORD','R1','R2','R3','R4','R5','R6','R7','R8']}].sum('locs').to_pandas().T
...
#%% Zonal Plots
day = '2015-03-01 23:00:00'
end = '2015-03-07 22:00:00'
