...
def impact_metrics(model_base, model_inst, start, stop):
    ...
    if model_inst.model_config['name'] == model_base.model_config['name']:
        ...
        gas_saving = only_gas_substitution/0.84
    ...
    delta_tot_costs = ((variable_costs+tot_ramping_cost_p2h) - (variable_costs_base+tot_ramping_cost_base))/(variable_costs_base+tot_ramping_cost_base)*100
    
    return(delta_ramping_costs,delta_tot_costs,curtailment,delta_tpes)
