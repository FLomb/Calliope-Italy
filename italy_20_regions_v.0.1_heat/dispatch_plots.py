...
def power_plot(model_inst, start, stop):
    ...
    for zone in locs_dict.keys():
        ...
        bioenergy_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':['biogas_new','biomass_wood','biofuel','biogas','wte'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T
        ...
        phs_supply_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':['phs','phs_new'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T 
        pv_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':['pv_rooftop','pv_rooftop_new','pv_farm','pv_farm_new'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T
        wind_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':['wind','wind_new'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T
        wind_off_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':['wind_offshore'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T
        ...
        phs_charge_dict[zone] = model_inst.get_formatted_array('carrier_con').loc[{'techs':['phs','phs_new'],'carriers':'electricity','locs':locs_dict[zone]}].sum('techs').sum('locs').to_pandas().T
        ...
        battery_supply_dict[zone] = model_inst.get_formatted_array('carrier_prod').loc[{'techs':'battery','carriers':'electricity','locs':locs_dict[zone]}].sum('locs').to_pandas().T
        battery_charge_dict[zone] = model_inst.get_formatted_array('carrier_con').loc[{'techs':'battery','carriers':'electricity','locs':locs_dict[zone]}].sum('locs').to_pandas().T
